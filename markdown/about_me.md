<img class="inline w-8 -mx-2" src="./images/classic_tv.gif"> Computer geek based in the 
...
<img class="inline w-6 -ml-1 mr-1" src="./images/falling_cat.gif">Programmer by night, known for [mov-cli](https://github.com/mov-cli/mov-cli), [roseate](https://github.com/cloudy-org/roseate), [aghpb-api](https://github.com/THEGOLDENPRO/aghpb_api) and [more](#projects-div).
...
For some reason I'm addicted with 🖥️ computers, ✈️ commercial aircraft, 💿 jpop and 🦀 software development. Regardless, **together** let's ensure next gen software is **[open](https://www.gnu.org/philosophy/free-sw.en.html)**, **ethical** and **free** as in **freedom**. 🦅